...
//        let view = UIView()
//        view.backgroundColor = .yellow
//        view.frame = CGRect(x: 100, y: 250, width: 80, height: 80)
//        view.frame = CGRect(x: UIScreen.screens.bounds., y: <#T##Double#>, width: <#T##Double#>, height: <#T##Double#>)
//        return view
//    }()
//    
//    
...
//
//        contentsView.topAnchor.constraint(equalTo: view.topAnchor, constant: 30).isActive = true
//        contentsView.bottomAnchor.constraint(equalTo: view.bottomAnchor).isActive = true
//        contentsView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 150).isActive = true
//        contentsView.trailingAnchor.constraint(equalTo: view.trailingAnchor).isActive = true
//        
